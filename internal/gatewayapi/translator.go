...
func newTranslateResult(gateways []*GatewayContext, httpRoutes []*HTTPRouteContext, tlsRoutes []*TLSRouteContext, xdsIR *ir.Xds, infraIR *ir.Infra) *TranslateResult {
...
func (t *Translator) ProcessTLSRoutes(tlsRoutes []*v1alpha2.TLSRoute, gateways []*GatewayContext, resources *Resources, xdsIR *ir.Xds) []*TLSRouteContext {
...
func addRoutesToListener(routeContext RouteContext, parentRef *RouteParentContext, routeRoutes []*ir.HTTPRoute, xdsIR *ir.Xds) {
